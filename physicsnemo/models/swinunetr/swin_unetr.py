...
from physicsnemo.models.utils.patch_embed import PatchEmbed2DSeparate as PatchEmbed
...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.patch_embed = PatchEmbed(
                ...
                dynamic_channels=6, 
                forcing_channels=5, 
                dynamic_embed_dim=128,  # <-- New: Explicit dim for dynamics, 128
                forcing_embed_dim=64,  # <-- New: Explicit dim for forcing, 64
